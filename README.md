...
- **Quick entry chips**: dates, times, priorities, labels, and recurrence parsed from the title appear as chips in the quick-add bar and the inspector; ✕ (or Space / Delete on a focused chip) keeps those words in the title.
